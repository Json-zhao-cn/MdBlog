import{_ as n,c as a,a as e,o as p}from"./app-DS8qI0Gg.js";const l={};function t(c,s){return p(),a("div",null,[...s[0]||(s[0]=[e(`<h3 id="use-stored-procedure-to-update-cdc-sync-control-table-data-only-two-dbs" tabindex="-1"><a class="header-anchor" href="#use-stored-procedure-to-update-cdc-sync-control-table-data-only-two-dbs"><span>Use stored procedure to update CDC_Sync_Control table data <strong>Only two dbs</strong></span></a></h3><h4 id="update-cdc-sync-control-table-current-start-lsn-and-seqval" tabindex="-1"><a class="header-anchor" href="#update-cdc-sync-control-table-current-start-lsn-and-seqval"><span>Update CDC_Sync_Control table current <code>__$start_lsn</code> and <code>__$seqval</code></span></a></h4><ol><li>After finished sync current <code>__$start_lsn</code> data from source db table to target DB. We need to record the sync <code>__$start_lsn</code> and <code>__$seqval</code> So, we will use a stored procedure to do it.The stored procedure is :</li></ol><div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql" data-title="sql"><pre><code><span class="line"><span class="token keyword">USE</span> <span class="token punctuation">[</span>YourDatabase<span class="token punctuation">]</span></span>
...
<span class="line">		SELECT TOP(1) </span>
<span class="line">			@OutMaxLSN_OUT = t.__$start_lsn,</span>
<span class="line">			@OutMaxSeq_OUT = t.__$seqval </span>
<span class="line">		FROM (</span>
<span class="line">			SELECT TOP(@PageSize) *</span>
...
<span class="line">		ORDER BY t.__$start_lsn DESC, t.__$seqval DESC;&#39;</span><span class="token punctuation">;</span></span>
<span class="line"></span>
<span class="line">    <span class="token comment">------------------------------------------------------------</span></span>
...
<span class="line">            N<span class="token string">&#39;@LastSyncLSN binary(10), @LastSeqVal varbinary(10),@PageSize int,</span>
...
<span class="line">        <span class="token keyword">EXEC</span> sp_executesql</span>
<span class="line">            <span class="token variable">@sql</span><span class="token punctuation">,</span></span>
<span class="line">            N<span class="token string">&#39;@NextLSN binary(10),@PageSize int,</span>
<span class="line">              @OutMaxLSN_OUT binary(10) OUTPUT, @OutMaxSeq_OUT varbinary(10) OUTPUT&#39;</span><span class="token punctuation">,</span></span>
...
<span class="line">    <span class="token keyword">WHERE</span> TableName <span class="token operator">=</span> <span class="token variable">@TableName</span><span class="token punctuation">;</span></span>
<span class="line"><span class="token keyword">END</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4)])])}const o=n(l,[["render",t]]),r=JSON.parse('{"path":"/blogs/Skills/SQLServer/StoredProcedure/usp_UpdateNextCDCTraceData.html","title":"Use stored procedure to update CDC_Sync_Control table data","lang":"en-US","frontmatter":{"title":"Use stored procedure to update CDC_Sync_Control table data","date":"2025/10/20","tags":["SQLServerCDC"],"categories":["Skills"]},"headers":[{"level":3,"title":"Use stored procedure to update CDC_Sync_Control table data Only two dbs","slug":"use-stored-procedure-to-update-cdc-sync-control-table-data-only-two-dbs","link":"#use-stored-procedure-to-update-cdc-sync-control-table-data-only-two-dbs","children":[]}],"git":{"createdTime":1762950152000,"updatedTime":1763625686000,"contributors":[{"name":"Zhao Json","email":"json.zhao@scania.com.cn","commits":1},{"name":"jsonzhao","email":"json.zhao.cn@outlook.com","commits":1}]},"filePathRelative":"blogs/Skills/SQLServer/StoredProcedure/usp_UpdateNextCDCTraceData.md"}');export{o as comp,r as data};
