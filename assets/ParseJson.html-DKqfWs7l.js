import{_ as n,c as a,a as e,o as i}from"./app-COHc9Lv0.js";const l={};function p(r,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="using-groovy-to-parse-json-array" tabindex="-1"><a class="header-anchor" href="#using-groovy-to-parse-json-array"><span><strong>Using groovy to parse Json array</strong></span></a></h1><h2 id="parse-specific-json-array" tabindex="-1"><a class="header-anchor" href="#parse-specific-json-array"><span><strong>Parse specific Json array</strong></span></a></h2><p>After get htttp data, we will get the specific json.Normally, when we use the native NIFI processor to parse json. It will be diffcult. So We will use groovy to parse it.</p><h3 id="_1-this-json-like-this" tabindex="-1"><a class="header-anchor" href="#_1-this-json-like-this"><span>1. This json like this:</span></a></h3><div class="language-json line-numbers-mode" data-highlighter="prismjs" data-ext="json" data-title="json"><pre><code><span class="line">  <span class="token punctuation">{</span></span>
